...
describe('Pet Management Suite', () => {
    ...
    describe('Pet List View', () => {
        it('should display pet list page with filters', () => {
            ...
            cy.get('[data-cy="species-filter"]').should('be.visible');
        ...
        it('should filter pets by species', () => {
            ...
            cy.get('body').then(($body) => {
                if ($body.find('[data-cy="pet-card"]').length > 0) {
                    cy.get('[data-cy="species-filter"]').then(($select) => {
        ...
        it('should filter pets by location', () => {
            cy.visit('/pets');
            cy.wait(2000);
            cy.get('[data-cy="location-filter"]').then(($select) => {
                const $options = $select.find('option');
                if ($options.length > 1) {
                    cy.wrap($select).select($options.eq(1).val());
                    cy.wait(500);
        ...
        it('should search pets by name', () => {
            cy.visit('/pets');
            cy.wait(2000);
            cy.get('[data-cy="search-input"]').type('Max');
            cy.wait(500);
        });
    });
    ...
    describe('Add Pet Flow', () => {
        ...
        it('should cancel and return to list view', () => {
            cy.get('[data-cy="pet-name-input"]').type('Should Not Save');
    ...
    describe('Pet Details Page', () => {
        ...
        it('should display pet details page', () => {
